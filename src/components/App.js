  ...
  render() {
    ...
    return (
      <div className={show ? 'menu-active' : ''}>
        <div>
          <NavBar
            leftContent={<Link style={{color: 'white', fontSize: '24'}} to="/"><span style={{cursor: 'pointer'}}><Icon size="large" style={{fontSize: 48}} type="bars" /></span></Link>}
            mode="dark"
